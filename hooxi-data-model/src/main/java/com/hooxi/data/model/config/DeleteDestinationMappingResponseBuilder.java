...
public final class DeleteDestinationMappingResponseBuilder {
    ...
    public DeleteDestinationMappingResponseBuilder withDeletedMapping(DestinationMappingResponse deletedMapping) {
        this.deletedMapping = deletedMapping;
        return this;
    }

    public DeleteDestinationMappingResponse build() {
        DeleteDestinationMappingResponse deleteDestinationMappingResponse = new DeleteDestinationMappingResponse();
