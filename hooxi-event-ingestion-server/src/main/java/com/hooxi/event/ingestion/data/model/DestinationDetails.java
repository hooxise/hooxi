...
public class DestinationDetails {
  ...
  public void setDestinationSecurityConfigResponse(
      DestinationSecurityConfigResponse destinationSecurityConfigResponse) {
  ...
  public static final class DestinationDetailsBuilder {
    ...
    public DestinationDetailsBuilder withDestinationResponse(
        DestinationResponse destinationResponse) {
      this.destinationResponse = destinationResponse;
      return this;
    }

    public DestinationDetailsBuilder withDestinationSecurityConfigResponse(
        DestinationSecurityConfigResponse destinationSecurityConfigResponse) {
      this.destinationSecurityConfigResponse = destinationSecurityConfigResponse;
      return this;
    }
